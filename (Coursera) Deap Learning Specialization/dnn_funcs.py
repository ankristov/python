...
def linear_forward(A_prev, W, b):
    ...
    #print('Parameters:')
    #print('A_prev.shape: ' + str(A.shape))
    #print('W: ' + str(W.shape))
...
def linear_backward(dZ, cache):
    ...
    #print('A_prev.shape = ' + str(cache[0].shape))
    #print('W.shape = ' + str(cache[1].shape))
    #print('b.shape = ' + str(cache[2].shape))
...
def relu_backward(dA, cache):
    ...
    dZ[Z < 0] = 0
    # For z > 0, dZ = dA (look my notes p. 17)
    assert(dZ.shape == Z.shape)
